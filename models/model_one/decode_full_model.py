                ...
                for ind_file, (start, finish) in enumerate(ext_inds):
                    ...
                    for ind_sent, sent in enumerate(article_beams):
                        ...
                        for hypothesis in sent:
                            file[ind_sent]['summarizer_logprob'].append(hypothesis.logprob)
                            file[ind_sent]['hypotheses'].append(" ".join(hypothesis.sequence))

                    with open(os.path.join('exported_beams', '{}.json'.format(count + ind_file)), 'w') as f:
